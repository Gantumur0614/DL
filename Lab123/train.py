...
model = ConvNET([
    ConvLayer(in_channels=1, out_channels=8, filter_dim=3, alpha=0.1),
    ReLU(),
    MaxPool(pool_size=2, stride=2),
    
    Flatten(),
    Linear_Layer(input_dim=14*14*8, output_dim=10, alpha=0.1)
])
...
for epoch in range(epochs):
    ...
    if avg_val_loss < min_val_loss:
        ...
        torch.save(
            checkpoint, "/home/gantumur/Documents/DL/Lab123/models/best_model_weights.pth")
