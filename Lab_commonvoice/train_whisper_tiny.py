...
if __name__ == "__main__":
    ...
    save_dir = "Lab_commonvoice/models/whisper_tiny_mongolian"
    
    processor = WhisperProcessor.from_pretrained("openai/whisper-tiny", language="Mongolian", task="transcribe")

    model = WhisperForConditionalGeneration.from_pretrained("openai/whisper-tiny")
    model.generation_config.forced_decoder_ids = processor.get_decoder_prompt_ids(language="Mongolian", task="transcribe")
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        save_total_limit=2,             
        push_to_hub=True,
        hub_model_id="Ganaa0614/whisper-tiny-mongolian-ver_0.4",
